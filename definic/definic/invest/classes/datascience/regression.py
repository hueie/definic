...
class Regression:
    ...
    def meanSquaredError(self,x_test,y_test):
    ...
    def hitRatio(self, x_test, y_test):
...
if __name__ == '__main__':
    ...
    x_train = [ [row] for row in train['open'] ]
    ...
    print("Predicted : ",linearregression.predict( x_test, y_test))
    print("Score : ", linearregression.score(x_test, y_test))
    print("Hit Ratio : ", linearregression.hitRatio(x_test, y_test))

    logisticregression = LogisticRegressionModel()
    print("Logistic Regression Start")    
    print("Train : ", logisticregression.train( x_train, y_train))
    print("Predicted : ",logisticregression.predict( x_test, y_test))
    print("Score : ", logisticregression.score(x_test, y_test))
    print("Hit Ratio : ", logisticregression.hitRatio(x_test, y_test))
   
    randomforest = RandomForestModel()
    print("Random Forest Start")    
    print("Train : ", randomforest.train( x_train, y_train))
    print("Predicted : ",randomforest.predict( x_test, y_test))
    print("Score : ", randomforest.score(x_test, y_test))
    print("Hit Ratio : ", randomforest.hitRatio(x_test, y_test))
        
    svc = SVCModel()
    print("SVC Start")    
    print("Train : ", svc.train( x_train, y_train))
    print("Predicted : ",svc.predict( x_test, y_test))
    print("Score : ", svc.score(x_test, y_test))
    print("Hit Ratio : ", svc.hitRatio(x_test, y_test))
