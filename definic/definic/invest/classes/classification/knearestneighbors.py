...
if __name__ == "__main__":
    ...
    normalized_x_train = knearestneighbors.minmaxnormalization(np.array(x_train))
    print(normalized_x_train)
    normalized_y_train = knearestneighbors.minmaxnormalization(np.array(y_train))
    print(normalized_y_train)
    
    knearestneighbors.train(x_train, y_train, 3)
    for x_test_row in x_test:
        knearestneighbors.test(x_test_row)
